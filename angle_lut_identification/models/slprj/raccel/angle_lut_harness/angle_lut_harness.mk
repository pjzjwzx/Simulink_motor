###########################################################################
## Makefile generated for component 'angle_lut_harness'. 
## 
## Makefile     : angle_lut_harness.mk
## Generated on : Tue Aug 18 11:19:22 2026
## Final product: ./angle_lut_harness.exe
...
PRODUCT_NAME              = angle_lut_harness
MAKEFILE                  = angle_lut_harness.mk
MATLAB_ROOT               = D:/Software/MATLAB/R2024b
MATLAB_BIN                = D:/Software/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Desktop/HKU_2/FOC_Arclab/simulink_2/angle_lut_identification/models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = angle_lut_harness_comp.rsp
CMD_FILE                  = angle_lut_harness.rsp
...
DEFINES_STANDARD = -DMODEL=angle_lut_harness -DNUMST=7 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness.c $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_capi.c $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_data.c $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_tgtconn.c $(START_DIR)/slprj/raccel/angle_lut_harness/rtGetInf.c $(START_DIR)/slprj/raccel/angle_lut_harness/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = angle_lut_harness.obj angle_lut_harness_capi.obj angle_lut_harness_data.obj angle_lut_harness_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
angle_lut_harness.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness.c
	$(CC) $(CFLAGS) -o "$@" "$<"


angle_lut_harness_capi.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


angle_lut_harness_data.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


angle_lut_harness_tgtconn.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/angle_lut_harness_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/angle_lut_harness/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
